...
export const DUMMY_RACES: Race[] = [
  ...
  {
    id: 'race_kol_05',
    name: 'The Calcutta Derby Stakes (Grade 1)',
    race_no: 5,
  ...
  {
    id: 'race_del_07',
    name: 'The Delhi Gold Cup',
    race_no: 1,
    venue: 'Delhi Race Club',
    race_time: '1:30 PM',
    date_str: 'Today, 5th Sep',
    distance: '1200m',
    going: 'Firm',
    class_grade: 'Grade 3 • 4yo & over',
    status: 'UPCOMING',
    image_url: '/images/horse_runner.jpg',
    winner_horse_id: null,
    place_horses_ids: [],
